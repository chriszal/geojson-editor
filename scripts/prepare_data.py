...
def backup_and_copy(filename):
    ...
    if dst.exists():
        ...
        backup = DATA_NEW / f"{dst.stem}_backup_before_pulled_{stamp}{dst.suffix}"
...
def main():
    ...
    if c1 and c2:
        print("Data preparation complete. Ready to proceed.")
